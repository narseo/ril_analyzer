...
public class NetworkLog extends SherlockFragmentActivity {
      ...
      public void handleMessage(Message msg) {
        ...
        switch(msg.what) {
          case NetworkLogService.MSG_BROADCAST_LOG_ENTRY:
            ...
            Log.d("SPC_NetworkLog", "NetworkLog.java --> Received entry: " + entry);       
            Log.d("SPC_NetworkLog", "NetworkLog. Handler. Updating LogFragment and appFragment");
  ...
  void doBindService() {
    Log.e("SPC_NetworkLog", "NetworkLog.doBindService");
    ...
    Log.e("SPC_NetworkLog", "NetworkLog.doBindService - should be done");
  ...
  public void loadSettings() {
    ...
    //Narseo Hardcoded options to avoid unnecessary DNS
    /*
    ...
    */
    ...
    //Narseo: hardcoded options
    /*
    startServiceAtStart = settings.getStartServiceAtStart();
    stopServiceAtExit = settings.getStopServiceAtExit();
    */
    startServiceAtStart = true;
    stopServiceAtExit = false;
  ...
  @Override
    public void onCreate(Bundle savedInstanceState)
    {
      ...
      //Narseo:Disable restored runs. Logging from boot
      //
      //Narseo: Disable history at the moment
      //Need to modify LogfileLoader.java 
      //to parse the new log file
  ...
  public void serviceToggle(View view) {
    ...
    if(!isServiceRunning(this, NetworkLogService.class.getName())) {
      Log.i("SPC_NetworkLog", "Click on button. Start Service");
      startService();
      loggingButton.setChecked(true);
    } else {
      stopService();
  ...
  public void startService() {
    Log.i("SPC_NetworkLog", "NetworkLog.startService. Starting service...");
