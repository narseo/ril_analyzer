...
public class ThroughputTracker {
  ...
  public static String TAG = "SPC_NetworkLog";
  ...
  static class ThroughputUpdater implements Runnable {
    ...
    public void run() {
      Log.i(TAG, "ThrougputTracker.Updater");
      String throughput;
      ...
      while(running) {
        synchronized(throughputMap) {
          ...
          if(!throughputMap.isEmpty()) {
            ...
            while(entries.hasNext()) {
              ...
              if(value.displayed == false) {
                ...
                if(NetworkLog.appFragment != null) {
                  ...
                  Log.i(TAG, "ThrougputTracker.Updater. App="+value.app.uid+" UP/DOWN: "+value.upload*8+"/"+value.download*8);
            ...
            //Log.i(TAG, "ThrougputTracker.Updater. Calling: updateThroughput (seems to be aggregated values). UP/DOWN: "+totalUpload*8+"/"+totalDownload*8);
  ...
  public static void startUpdater() {
    Log.i(TAG, "ThroughputTracker.startUpdater invoked");
