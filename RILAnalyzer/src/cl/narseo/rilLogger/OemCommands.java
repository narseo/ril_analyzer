...
class OemCommands {
    ...
    private static final String TAG = "SPC_OemCommands";
    ...
    public static byte[] getEnterServiceModeData(int modeType, int subType, int query) {
		Log.i(TAG, "getEnterServiceModeData. ModeType: "+modeType+" / SubType: "+subType+" /query: "+query);
        try {
    ...
    public static byte[] getEndServiceModeData(int modeType) {
		Log.i(TAG, "getEndServiceModeData(). ModeType: "+modeType);
        try {
            ByteArrayOutputStream baos = new ByteArrayOutputStream();
            DataOutputStream dos = new DataOutputStream(baos);
            dos.writeByte(OEM_SERVM_FUNCTAG);
    ...
    public static byte[] getPressKeyData(int keycode, int query) {
		Log.i(TAG, "getPressKeyData(). Keycode: "+keycode+"/Query: "+query);
        try {
            ByteArrayOutputStream baos = new ByteArrayOutputStream();
            DataOutputStream dos = new DataOutputStream(baos);
            dos.writeByte(OEM_SERVM_FUNCTAG);
